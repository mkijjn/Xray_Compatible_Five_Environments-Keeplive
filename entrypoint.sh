...
# 设置各变量
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'6b2d7619-0b01-4f99-974c-191dc45bad8a'}

# 其他Paas保活
PAAS1_URL=https://ceshi0513.onrender.com
PAAS2_URL=https://test0517-nira2aqf.b4a.run
PAAS3_URL=
PAAS4_URL=
PAAS5_URL=
PAAS6_URL=
...
ARGO_AUTH='{"AccountTag":"f69bf3cd59bdc8f8709369e03e7ace8b","TunnelSecret":"UhYRz359CzqG9r7SZVIK17xbjqiJCTmVR7ExRVtcHNM=","TunnelID":"ba6764ca-dc41-4b11-beaa-612a780853b5"}'
ARGO_DOMAIN=pps.cmkjgfh.cf
